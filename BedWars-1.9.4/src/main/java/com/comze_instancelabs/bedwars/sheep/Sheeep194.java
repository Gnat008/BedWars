...
public class Sheeep194 extends EntitySheep implements Sheeep {

	public Sheeep194(World world, Entity target) {
		super(world);
		...
		this.goalSelector.a(0, new PathfinderGoalMeleeAttack194(this, /*EntityHuman.class,*/ 1D, false));
