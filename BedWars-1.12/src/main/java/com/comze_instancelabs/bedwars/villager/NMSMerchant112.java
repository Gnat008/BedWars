...
public class NMSMerchant112 {
	private NMSMerchantRecipeList112 o = new NMSMerchantRecipeList112();
	...
	public void addOffer(MerchantRecipe recipe) {
		this.o.add(new NMSMerchantRecipe112(recipe));
	}
	...
	public void setRecipes(NMSMerchantRecipeList112 recipes) {
		this.o = recipes;
	}
