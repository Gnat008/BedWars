...
public class NMSMerchantRecipe112 {
	private MerchantRecipe merchantRecipe;

	public NMSMerchantRecipe112(MerchantRecipe merchantRecipe) {
		this.merchantRecipe = merchantRecipe;
	}

	public NMSMerchantRecipe112(ItemStack item1, ItemStack item3) {
		// ItemStack.a is EMPTY constant (new ItemStack(null))
		this(item1, ItemStack.a, item3);
	}

	public NMSMerchantRecipe112(ItemStack item1, ItemStack item2, ItemStack item3) {
