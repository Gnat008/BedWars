...
public class Register112 extends Register {

	public boolean registerEntities() {
		
		MinecraftKey localMinecraftKey = new MinecraftKey("Sheeep");
		EntityTypes.b.a(91, localMinecraftKey, Sheeep112.class);
		EntityTypes.d.add(localMinecraftKey);
		
		return true;
	}

	public Sheeep112 spawnSheep(Plugin m, final Location t, Player target, final int color) {
		final Object w = ((CraftWorld) t.getWorld()).getHandle();
		final Sheeep112 t_ = new Sheeep112((World) ((CraftWorld) t.getWorld()).getHandle(), (Entity) ((CraftPlayer) target).getHandle());
